...
<footer id="footer">
  <div class="wrapper footer_menu">
    <h1 class="footer_logo">
      <a href=<?php echo esc_url(home_url('/')); ?>><img src="<?php echo get_template_directory_uri(); ?>/asset/img/top/logo.png" alt="purebread-logo"></a>
    </h1>
    <div class="site_area">
      <ul class="site_map_area">
        <li><a href=<?php echo esc_url(home_url('/')); ?>>ＴＯＰ　ＰＡＧＥ</a></li>
        <li><a href=<?php echo esc_url(home_url('/about')); ?>>ＡＢＯＵＴ　ＵＳ</a></li>
        <li><a href=<?php echo esc_url(home_url('/menu')); ?>>ＭＥＮＵ</a></li>
        <li><a href=<?php echo esc_url(home_url('/blog')); ?>>ＢＬＯＧ＆ＩＮＦＯ</a></li>
        <li><a href=<?php echo esc_url(home_url('/#access')); ?>>ＡＣＣＥＳＳ</a></li>
        <li><a href=<?php echo esc_url(home_url('/contact')); ?>>ＣＯＮＴＡＣＴ</a></li>
      </ul>
      <ul class="sns_area">
        <li class="sns-icons">
